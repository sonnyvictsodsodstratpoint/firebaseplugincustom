...
Log.e(LOG_TAG, "execute: Got JSON Exception " + e.getMessage());
    ...
    public void initialize(CordovaInterface cordova, CordovaWebView webView) {
        ...
        if (cordova.getActivity().getIntent() != null &&
                cordova.getActivity().getIntent().getExtras() != null) {
            ...
            if (from != null && NotificationHandlerUtil.isAvailableSender(applicationContext, from)) {
                NotificationHandlerUtil.handleMessage(applicationContext, extras, true);
            }
